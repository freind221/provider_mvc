...
// import 'package:provider_mvc/reposety/auth_repo.dart';
...
//   Future<void> loginview(dynamic data, BuildContext context) async {
//     setLoading(true);
//     myrepo.loginApi(data).then((value) {
//       setLoading(false);
//       Utils.flushBarSnakError('Login Successfully', context);
